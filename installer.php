...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210508_quesera_aae1e90d3eb3067b2996_20210514174901_archive.zip';
	const ARCHIVE_SIZE		 = '78559531';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'aae1e90-14174901';
    const SECONDARY_PACKAGE_HASH = 'cb7b9f3-14174901';
	const VERSION			 = '1.4.0';
